...
data = [[1, 3, 0], [2, 4, 0], [3, 5, 0], [4, 3, 1], [5, 8, 1], [6, 3, 2], [8, 1, 2]]
    ...
    while w_converge == False:
        ...
        for e in range(len(c)):
            ...
            for d in range(len(data)):
                if data[d][2] == e:
                    temp_sum = temp_sum + math.exp(-l*(data[d][0] - c[e])**2)
            phi_n.append(temp_sum)
...
while converge == False:
    ...
    while w_converge == False:
        ...
        for d in range(len(data)):
            ...
            phi_n.append(math.exp(-l*(data[d][0] - c[d])**2))
